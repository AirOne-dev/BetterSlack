...
Un bouton dans la barre de gauche, à côté de votre avatar, ou `⌘⇧H`, ou `⌘K` → **Historique**. Une pastille dessus compte ce qui est arrivé depuis votre dernier passage.
