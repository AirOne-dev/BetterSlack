...
- Attribuez-lui autant de raccourcis que vous voulez dans ses réglages, ou lancez « Modifier les raccourcis » depuis la palette et appuyez sur les touches. Ce que vous attribuez est repris à Slack s’il l’utilisait déjà — la palette écoute avant l’application.
- Elle est sur ⌘K exprès : c’est la touche vers laquelle tout le monde va. Le sélecteur de Slack reste à un clic dans le champ de recherche, et ⌘⇧K le remet si vous n’êtes pas d’accord.
