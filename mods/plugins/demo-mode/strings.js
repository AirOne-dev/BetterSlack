// What Demo Mode says, in every language it says it in.
//
...
export const STRINGS = {
  en: {
    ...
    shoot: 'Take a screenshot',
    shootHint: 'At the size the site and the readmes use, into your downloads',
    saved: 'Saved {name} to your downloads.',
    failed: 'Could not take the picture: {reason}',
    ...
    sweep: 'Sweep again',
    sweepHint: 'Replace whatever Slack has drawn since',
    swept: 'Swept again.',
  },
  fr: {
    toggle: 'Mode démo',
    ...
    shoot: 'Prendre une capture',
    shootHint: 'À la taille du site et des readmes, dans vos téléchargements',
    saved: '{name} enregistré dans vos téléchargements.',
    failed: 'Capture impossible : {reason}',
    ...
    sweepHint: 'Remplacer ce que Slack a dessiné depuis',
    swept: 'Balayage refait.',
  },
};
