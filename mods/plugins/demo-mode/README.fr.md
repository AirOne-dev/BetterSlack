...
- **Un appareil photo apparaît à côté pendant une démo.** Il dessine la fenêtre à la taille qu'utilisent le site et les readmes, la photographie, et dépose le fichier dans vos téléchargements — avec un éclair, pour que ça se voie. L'interrupteur, l'appareil et le bandeau de BetterSlack sortent du champ d'abord : l'image est celle de Slack, pas celle de l'appareil.
